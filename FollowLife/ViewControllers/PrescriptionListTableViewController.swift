...
//  FollowLife
//
//  Created by Hillari Zorrilla Delgado on 6/21/18.
...
class PrescriptionListTableViewController: UITableViewController {
    ...
    func loadPatient(idPatient: String){
        Alamofire.request("\(FollowLifeApi.doctorsUrl)/\(self.idDoctor)/patients/\(idPatient)", method: .get, encoding: JSONEncoding.default, headers: ["X-FLLWLF-TOKEN": self.token, "Content-Type": "application/json"]).responseJSON { (response) in
